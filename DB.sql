...
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (1,6, '开始,停止, 进入下一阶段', '说明: 暖身操(暖身操) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (2,2, '待机,一级,二级,三级,大幕拉开,下一章节', '说明: 动画片(动画串场) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (2,7, '开始,停止', '说明: 动画片(动画剧院) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (3,12, '待机,一级,二级,三级,进入下一阶段,彩,虹,小,屋,彩虹谷,小怪物,创造游戏,下一章', '说明: 造房子(造房串场) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (3,4, '监视器,彩虹谷,进入下一阶段', '说明: 造房子(互动) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (3,8, '盖章,咔嚓', '说明: 造房子(拍照) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (3,10, '', '说明: 造房子(示范造房) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (3,11, '', '说明: 造房子(学生造房) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (4,9, '方块,凹凸,12块,20块,启动,监视器,结束,下课', '说明: 拼图(拼图) - OH, 菊花!!!!!!');
INSERT INTO `course_item`(`course_id`, `item_id`, `keys_info`, `fck_desc`) VALUES (4,14, '待机,进入下一阶段', '说明: 拼图(拼图串场) - OH, 菊花!!!!!!');
